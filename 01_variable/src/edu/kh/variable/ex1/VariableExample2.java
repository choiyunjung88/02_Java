...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		// * 카멜 표기법
		// 연결되는 두 단어중 후속 단어의 첫 문자를 대문자로 표기
	...
	// 자료형  변수명     =   리터럴;
		 ...
		 * 'B' 문자 그대로 대입되면 변수에 새로운 숫자 66으로 변환되어 저장
